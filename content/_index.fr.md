...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |
        {{% cta cta_link="./participate/" cta_text="Participer à nos études →" %}}
    design:
      columns: '1'
  - block: collection
    content:
